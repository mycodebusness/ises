...
import { Cours as Payment } from "@/lib/types";
...
import { deleteCours } from "@/lib/actions";

export const columns: ColumnDef<Payment>[] = [
  {
    accessorKey: "id_cours",
    header: "Id",
    cell: ({ row }) => (
      <div className="capitalize">{row.original.id_cours}</div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">{row.original.ponderation}</div>
    ),
  },
  {
    accessorKey: "nom_promotion",
    header: "Nom promotion",
    cell: ({ row }) => (
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link className="flex gap-3" href={`/dashboard/cours/ajouter`}>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  href={`/dashboard/cours/${row.original.id_cours}`}
                >
              ...
              <TooltipContent className="flex gap-2 justify-center items-center">
                ...
                <p>modifier le cours {row.original.id_cours}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="flex gap-2 justify-center items-center">
                  ...
                  <p>supprimer l&apos;cours {row.original.id_cours}</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
    ...
    <div className="w-full px-4 pt-4">
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        <div className="flex-1 text-sm text-muted-foreground">
          Total : {table.getFilteredRowModel().rows.length} cours
        </div>
