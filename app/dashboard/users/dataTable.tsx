...
import { Users as Payment } from "@/lib/types";
...
export const columns: ColumnDef<Payment>[] = [
  ...
  },
  {
    accessorKey: "mdp",
    header: "Mot de passe",
    cell: ({ row }) => <div className="capitalize">{row.getValue("mdp")}</div>,
  },
  {
    id: "actions",
    enableHiding: false,
      ...
      return (
        <div className="flex gap-3">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent className="flex gap-2 justify-center items-center">
                ...
                <p>modifier l&apos;utilisateur {row.original.login}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <Dialog>
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="flex gap-2 justify-center items-center">
                  ...
                  <p>
                    supprimer l&apos;utilisateur {row.original.login} dans le
                    système
                  </p>
                </TooltipContent>
              </Tooltip>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle> Suppression utilisateur</DialogTitle>
                <DialogDescription>
                  Etes-vous sur de supprimer l&apos;utilisateur{" "}
                  {row.original.login}
                  définitivement dans le système?
                </DialogDescription>
              </DialogHeader>
                ...
                <Button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      toast({
                        title: "Supprimer",
                        description: `l'utilisateur ${row.original.login} a été supprimer avec succès`,
