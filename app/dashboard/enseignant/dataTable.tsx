...
export const columns: ColumnDef<Payment>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="capitalize">{row.original.prenom}</div>,
  },
  {
  ...
  },
  {
    accessorKey: "grade",
    header: "Grade",
    cell: ({ row }) => <div className="capitalize">{row.original.grade}</div>,
  },
  {
    accessorKey: "num_tel",
    header: "Téléphone",
    cell: ({ row }) => <div className="capitalize">{row.original.num_tel}</div>,
  },
  {
    header: "Actions",
    id: "actions",
            ...
            <DialogContent>
              ...
              <DialogFooter className="justify-end">
                ...
                <Button
                  ...
                  onClick={async () => {
                    try {
                      await deleteEnseignant(Number(row.original.mat_ens));
                      toast({
                        title: "Supprimer",
